 ...
 * Generated at: 2020-08-31 10:09:07 UTC
...
return;
    ...
    if (userLoggedIn) {
      ...
      out.write("\t\t\t\t\t<label>FirstName :</label> <input\r\n");
      ...
      out.write("\t\t\t\t\t");
      out.print(HTMLUtility.getList("roleId",ServletUtility.getParameter("roleId", request) , roleList) );
      out.write("\r\n");
      out.write("\t\t\t\t\t&emsp; \r\n");
      out.write("\t\t\t\t\t<label>LoginId:</label> <input type=\"text\" name=\"login\" placeholder=\"Enter Login Id\"\r\n");
      out.write("\t\t\t\t\tvalue=\"");
 ...
 if(bean.getRoleId()==1){
      ...
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t<td><input type=\"button\" name=\"operation\"\r\n");
      out.write("\t\t\t\t\tvalue=\"");
      out.print(UserListCtl.OP_NEW);
      out.write("\" onclick=\"location.href='/ORS4/ctl/UserCtl';\"></td>\r\n");
